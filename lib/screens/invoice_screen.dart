...
class _InvoiceScreenState extends State<InvoiceScreen> {
                ...
                children: [
                  ...
                  pw.Expanded(
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text(_bizTagline,
                            style: s(regular, 9, const PdfColor.fromInt(0xFF94A3B8))),
                        pw.SizedBox(height: 10),
                        pw.Container(height: 1, width: 160,
                            color: const PdfColor.fromInt(0xFF334155)),
                        pw.SizedBox(height: 10),
                        pw.Text(_bizAddr1, style: s(regular, 8.5, const PdfColor.fromInt(0xFFCBD5E1))),
                        pw.Text(_bizAddr2, style: s(regular, 8.5, const PdfColor.fromInt(0xFFCBD5E1))),
                        pw.SizedBox(height: 5),
                        pw.Row(children: [
                          pw.Text('TIN: ', style: s(bold, 8.5, const PdfColor.fromInt(0xFF94A3B8))),
                          pw.Text(_bizTin,  style: s(regular, 8.5, const PdfColor.fromInt(0xFFCBD5E1))),
                        ]),
                      ],
                    ),
                  ),
                  ...
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: 10),
                      _pdfMetaRow('Invoice No.',
                          inv['invoice_id']?.toString() ?? '—', bold, regular, white),
                      pw.SizedBox(height: 4),
                      _pdfMetaRow('Order No.',
                          inv['order_id']?.toString() ?? '—', bold, regular,
                          const PdfColor.fromInt(0xFFCBD5E1)),
                      pw.SizedBox(height: 4),
                      _pdfMetaRow('Date Issued',
                          fmtDate(inv['issued_date']), bold, regular,
                          const PdfColor.fromInt(0xFFCBD5E1)),
                  ...
                  pw.Expanded(
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.SizedBox(height: 3),
                        pw.Text('TIN: $_bizTin', style: s(regular, 8.5, textMid)),
                      ],
                    ),
                  ),
                  ...
                  children: [
                    ...
                    pw.Table(
                      ...
                      children: [
                        ...
                        ...items.asMap().entries.map((e) {
                          ...
                          final details =
                              [if (size != null) size, if (mat != null) mat].join(' · ');
                          final bg = idx.isEven
                              ? PdfColors.white
                              : rowAlt;
                          return pw.TableRow(
                            ...
                            children: [
                              pw.Padding(
                                ...
                                child: pw.Column(
                                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                                  children: [
                                    pw.Text(name, style: s(bold, 9.5, textDark)),
                                    if (details.isNotEmpty)
                                      pw.Text(details, style: s(italic, 8, textMid)),
                                  ],
                                ),
                              ),
                              pw.Padding(
                                padding: const pw.EdgeInsets.symmetric(
                                    horizontal: 10, vertical: 8),
                                child: pw.Text('$qty', style: s(regular, 9.5, textDark)),
                              ),
                              pw.Padding(
                                padding: const pw.EdgeInsets.symmetric(
                                    horizontal: 10, vertical: 8),
                                child: pw.Text(php(unit), style: s(regular, 9.5, textDark)),
                              ),
                              pw.Padding(
                                padding: const pw.EdgeInsets.symmetric(
                                    horizontal: 10, vertical: 8),
                                child: pw.Text(php(sub), style: s(bold, 9.5, textDark)),
                              ),
                            ],
                          );
                        }),
                        ...
                        pw.Container(
                          ...
                          child: pw.Column(children: [
                            ...
                            pw.Padding(
                              ...
                              child: pw.Column(children: [
                                _pdfSummaryRow('Order Total', php(total),
                                    regular, bold, textMid, textDark, false),
                                pw.SizedBox(height: 7),
                                _pdfSummaryRow('Downpayment Paid', php(paid),
                                    regular, bold, textMid, paidGreen, false),
                                pw.SizedBox(height: 7),
                                pw.Container(height: 0.8, color: rowBorder),
                                pw.SizedBox(height: 7),
                                _pdfSummaryRow(
                                  isFullyPaid ? 'Balance' : 'Balance Due on Pickup',
                    ...
                    pw.Container(
                      ...
                      child: pw.Row(
                        ...
                        children: [
                          pw.Text('$_bizName  ·  TIN: $_bizTin',
                              style: s(bold, 8, textMid)),
                          pw.Text('$_bizAddr1, $_bizAddr2',
  ...
  static pw.Widget _pdfMetaRow(
    ...
    pw.Font bold, pw.Font regular, PdfColor valueColor,
  ) => pw.Row(mainAxisAlignment: pw.MainAxisAlignment.end, children: [
    pw.Text('$label  ', style: pw.TextStyle(
        font: regular, fontSize: 8.5,
        color: const PdfColor.fromInt(0xFF64748B))),
    pw.Text(value, style: pw.TextStyle(
        font: bold, fontSize: 8.5, color: valueColor)),
  ]);
  ...
  static pw.Widget _pdfSummaryRow(
    ...
    pw.Text(label, style: pw.TextStyle(
        font: labelFont, fontSize: large ? 10 : 8.5, color: labelColor)),
    pw.Text(value, style: pw.TextStyle(
        font: valueFont, fontSize: large ? 12 : 10, color: valueColor)),
  ]);
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              widget.fromPayment ? 'Payment Confirmed ✓' : 'Official Sales Invoice',
                    ...
                    children: [
                      ...
                      Text(inv['customer_name']?.toString() ?? '—',
                          style: const TextStyle(
                              ...
                              fontSize: 13,
                              fontWeight: FontWeight.w600)),
                      Text(inv['customer_email']?.toString() ?? '—',
                          style: const TextStyle(
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Padding(
                      ...
                      child: Column(children: [
                        _PayRow(label: 'Order Total',
                            value: total,
                            color: Colors.white70,
                            large: false),
                        const SizedBox(height: 10),
                        _PayRow(label: 'Downpayment Paid',
                            value: paid,
                            color: Colors.green,
                            large: false),
                        const SizedBox(height: 10),
