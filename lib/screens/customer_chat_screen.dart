...
// =============================================================================
// CustomerOrderChatScreen  (rename to match your actual class name if different)
// =============================================================================
...
class _Bubble extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // "Me" (customer) = right side, amber-tinted solid bubble
    // "Them" (employee/shop) = left side, white glass bubble
    return Padding(
      ...
      child: Row(
        ...
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          // Shop avatar — only for incoming, only on first in group
          if (!isMe) ...[
            if (isFirst)
              Container(
                width: 34,
...
// "My" message — solid amber-tinted with good contrast
class _MeBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        // Solid enough to stand out against any background
...
// "Their" message — frosted glass white
