            ...
            child: Column(
              ...
              children: [
                ...
                _ContactRow(Icons.location_on_outlined,
                    'Rongavilla Bldg., Ground Floor, Unit 4, 5th street, Pacita Ave. San Pedro Laguna'),
                const SizedBox(height: 8),
                _ContactRow(Icons.phone_outlined, '+63 917 - 585 - 6200'),
                const SizedBox(height: 8),
                _ContactRow(Icons.email_outlined, 'fabrication@imprentainc.net'),
                const SizedBox(height: 8),
